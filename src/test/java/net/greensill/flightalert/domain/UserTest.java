...
/**
 * Created by stevengreensill on 3/1/16.
 */
public class UserTest {
    ...
    @Test
    public void testSaveFlightRequest() {

        // Here we test the use case of loading a combo box
        ...
        try {
            ...
            slice.setPreferredCabin("BUSINESS");
            slice.setDate("2016-06-08");
            List<String> permittedCarriers = new ArrayList<String>();
            permittedCarriers.add("LX");
            slice.setPermittedCarrier(permittedCarriers);
            slices.add(slice);

            slice = new SliceInput();
            slice.setOrigin("SFO");
            slice.setDestination("MXP");
            slice.setPreferredCabin("BUSINESS");
            slice.setDate("2016-06-21");
            permittedCarriers = new ArrayList<String>();
            permittedCarriers.add("LX");
            slice.setPermittedCarrier(permittedCarriers);
            slices.add(slice);

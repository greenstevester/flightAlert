package net.greensill.flightalert.config.social;

import net.greensill.flightalert.repository.SocialUserConnectionRepository;
import net.greensill.flightalert.repository.CustomSocialUsersConnectionRepository;
import net.greensill.flightalert.security.social.CustomSignInAdapter;
